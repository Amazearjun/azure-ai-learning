...
namespace Azure_ai_learning_playground
{
    public partial class RegularExpressionModel
    {
        public const string RetrainFilePath =  @"C:\Users\ArjunSridharan\Downloads\Housing_Complex_Data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"City", @"City"),new InputOutputColumnPair(@"Type", @"Type"),new InputOutputColumnPair(@"CarParking", @"CarParking"),new InputOutputColumnPair(@"GatedCommunity", @"GatedCommunity")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    .Append(mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"Area", @"Area"),new InputOutputColumnPair(@"Size", @"Size")}))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"City",@"Type",@"CarParking",@"GatedCommunity",@"Area",@"Size"}))      
